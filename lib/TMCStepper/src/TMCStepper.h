...
// NOTE: This project uses TMCStepper in a bare-metal STM32 HAL environment.
// Arduino/SoftwareSerial/SPI helpers are intentionally not used.
// Provide a minimal Stream interface + HAL timing hooks via local headers.
